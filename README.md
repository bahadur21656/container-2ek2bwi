...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-2ek2bwi.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-2ek2bwi.containers.anotherwebservice.com/
...
```
git clone git@github.com:bahadur21656/container-2ek2bwi.git
cd container-2ek2bwi
```
...
```
docker attach container-2ek2bwi
```
